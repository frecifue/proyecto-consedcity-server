...
api.post("/image_gallery", [md_auth.asureAuth, dynamicUploadDir, md_upload], ImageGalleryController.createImageGallery);
api.patch("/image_gallery/:gimId", [md_auth.asureAuth, dynamicUploadDir, md_upload], ImageGalleryController.updateImageGallery);
